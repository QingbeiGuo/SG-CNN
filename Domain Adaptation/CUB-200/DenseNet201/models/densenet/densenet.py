...
from models.densenet.layers import MaskedConv2d
from models.densenet.layers import MaskedLinear
...
class Self_GroupingDenseNetModel(nn.Module):
    ...
    """
    def __init__(self, in_shape=(3,244,244), num_classes=200, growth_rate=32, block_config=(6, 12, 24, 16),
