...
class densenet(_fasterRCNN):
  def __init__(self, classes, num_layers=101, pretrained=False, class_agnostic=False):
    ...
    self.model_path = '/data/qingbeiguo/work/gcnn-Faster-rcnn/faster-rcnn.pytorch-pytorch-1.0-1-res50-coco-600-G80/lib/model/faster_rcnn/pretrained_model/model_training_G80.pth'
