...
class densenet(_fasterRCNN):
  def __init__(self, classes, num_layers=101, pretrained=False, class_agnostic=False):
    ...
    self.model_path = '/data/qingbeiguo/work/gcnn-Faster-rcnn/faster-rcnn.pytorch-pytorch-1.0-dense201-coco-600-LG70/lib/model/faster_rcnn/pretrained_model/model_training_LG70.pth'
