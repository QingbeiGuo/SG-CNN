...
class resnet(_fasterRCNN):
  def __init__(self, classes, num_layers=101, pretrained=False, class_agnostic=False):
    ...
    self.model_path = '/data/qingbeiguo/work/faster-rcnn.pytorch-pytorch-1.0/faster-rcnn.pytorch-pytorch-1.0/lib/model/faster_rcnn/pretrained_model/model_resnet50.pth'
